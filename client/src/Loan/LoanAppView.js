        ...
        <div id="print-section" className="bg-white p-6 shadow-md rounded-lg">
          ...
          <div className="text-lg">
            ...
            <Descriptions bordered column={1} size="middle" className="text-gray-800">
              ...
              <Descriptions.Item label="Abroad Date">
    {loanApp.abroadDate ? new Date(loanApp.abroadDate).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }) : 'N/A'}
  </Descriptions.Item> {/* Added Abroad Date field */}
            </Descriptions>
